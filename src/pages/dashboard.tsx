...
//     try {
//       const response = await axios.get(`/orders?timePeriod=${timePeriod}`);
...
//               </div>
//               <div>
//                 <select className="px-4 py-2 border border-gray-300 rounded-md focus:outline-none" onChange={handleTimePeriodChange}>
...
//             </div>
//             <div className="">
//               <DataCard orders={filteredOrders} />
//             </div>
//             <div style={{ display: "flex", marginTop: "5%" }}>
//               <div style={{ background: "white", width: "662px", height: "364px", padding: "10px", marginRight: "4%", borderRadius: "9px" }}>
//                 <LineChart data={[
